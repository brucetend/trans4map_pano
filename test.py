...
model_path = "/home/zteng/Trans4Map/checkpoints/pano_top_down_mapping/40epoch_train/ckpt_model.pkl"
...
###########################################################################################
config_path = "model/model_pano.yml"
...
with torch.no_grad():
    for batch in testingloader:
        ...
        if observed_masks.any():
            ...
            # print('semmap_gt:', semmap_gt_write.size())
